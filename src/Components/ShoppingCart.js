...
let ALL_PRODUCTS_IN_CART_URL = 'http://ecommerce-reactive-mind.vercel.app/user/viewcart';
let ADD_CART_TO_CART_URL = 'http://ecommerce-reactive-mind.vercel.app/user/add-to-cart';
let DELETE_A_PRODUCT_FROM_CART = 'http://ecommerce-reactive-mind.vercel.app/user/delete-from-cart'; // this will delete the product from the cart no matter the quantity
let DELETE_ALL_PRODUCTS_FROM_CART = 'http://ecommerce-reactive-mind.vercel.app/user/clear-cart';
let UPDATE_CART_URL = 'http://ecommerce-reactive-mind.vercel.app/user/update-cart';
...
function ShoppingCart() {
    ...
    const fetchProductsInCart = async () => {
        ...
        setIsLoading(true);
        try {
            const response = await FetchWithAuth('http://ecommerce-reactive-mind.vercel.app/user/viewcart', {
                method: 'GET',
                headers: {
    ...
    const addToCart = async (productId, quantity) => {
        ...
        try {
            await FetchWithAuth('http://ecommerce-reactive-mind.vercel.app/user/add-to-cart', {
                method: 'POST',
                headers: {
    ...
    const updateQuantity = async (productId, newQuantity) => {
        ...
        const response = await fetch('http://ecommerce-reactive-mind.vercel.app/user/update-cart', {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
    ...
    const deleteFromCart = async (productId) => {
        try {
            await FetchWithAuth('http://ecommerce-reactive-mind.vercel.app/user/delete-from-cart', {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${accessToken}`
    ...
    const deleteAllProductsFromCart = async () => {
        try {
            await FetchWithAuth('http://ecommerce-reactive-mind.vercel.app/user/clear-cart', {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${accessToken}`
                }
 ...
 * // new quantity to also adjust its amount in the cart itself
  const updateQuantity = async (productId, newQuantity) => {
     ...
     const deleteFromCart = async (productId) => {
        const response = await fetch(`http://ecommerce-reactive-mind.vercel.app/user/delete-from-cart/${productId}`, {
            method: 'DELETE',
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('accessToken')}`
            }
